    ...
    <SidebarInset className='flex h-full w-full bg-transparent'>
      ...
      <div className="flex bg-primary-foreground rounded-2xl flex-1 items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold mb-2 bg-gradient-chat bg-clip-text text-transparent">Chào mừng bạn đến với chatapp</h2>
          <p className="text-muted-foreground">Chọn một cuộc hội thoại để bắt đầu chát.</p>
        </div>
      </div>
    </SidebarInset >
  )
...
export default ChatWelcomeSreen